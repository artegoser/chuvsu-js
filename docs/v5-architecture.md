...
аудиторий. Это входные HTML для проверки устойчивости парсинга и объединения,
но не эталон правильных значений. Эталонные JSON компактны, составлены вручную
по исходному HTML и не создаются генератором. Отдельные тесты проверяют
